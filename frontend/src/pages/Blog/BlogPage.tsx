  ...
  return (
    <PageWrapper>
      <Helmet>
        ...
        <meta
          name="description"
          content="Khám phá xu hướng thiết kế đồ họa và công nghệ mới nhất."
        />
      </Helmet>
      <BackgroundAura />
      <Navbar />
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <HeroSection>
          <header className="mb-12">
            ...
            >
              Cảm hứng & <br />
              <span className="text-primary-500">Tin tức thiết kế</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              Tổng hợp những xu hướng, kiến thức và câu chuyện truyền cảm hứng
              từ thế giới đồ họa & công nghệ.
            </motion.p>
          </header>
            ...
            primaryFeatured && (
              <HeroGrid>
                ...
                >
                  <img
                    src={
                      primaryFeatured.image
                        ? primaryFeatured.image.startsWith("http")
                          ? primaryFeatured.image
                          : `${API_URL}${primaryFeatured.image}`
                        : primaryFeatured.thumbnail ||
                  ...
                  <div className="overlay">
                    ...
                    {primaryFeatured.slug ? (
                      <Link
                        ...
                        className="bg-white text-slate-900 px-8 py-4 rounded-full font-bold w-fit hover:bg-primary-500 hover:text-white transition-all shadow-xl shadow-white/5"
                      >
                        Đọc bài viết
                      </Link>
                    ) : (
                      <a
                        href={primaryFeatured.url}
                        target="_blank"
